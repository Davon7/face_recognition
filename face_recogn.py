...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by DAVID</h6>", unsafe_allow_html=True)

           

st.image('pngwing.com (4).png', caption = 'Built by David', width=400)
...
if   st.button('Read the usage Instruction below'):
     st.success('Hello User, these are the guideline for the app usage')
